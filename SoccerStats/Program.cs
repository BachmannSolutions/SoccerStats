...
namespace SoccerStats
{
    class Program
    {
        ...
        public static List<NewsResult> GetNewsForPlayer(string playerName)
        {
            ...
            var webClient = new WebClient();
            webClient.Headers.Add("Ocp-Apim-Subscription-Key", "04f5faa908884e3485e1460d33ae0516");
            byte[] searchResults = webClient.DownloadData(string.Format("https://api.cognitive.microsoft.com/bing/v7.0/news/search", playerName));
            var serializer = new JsonSerializer();
        ...
        public static SentimentResponse GetSentimentResponse(List<NewsResult> newsResults)
        {
            ...
            var webClient = new WebClient();
            webClient.Headers.Add("Ocp-Apim-Subscription-Key", "8dcf75787e434e18b17d481e065c92d3");
            webClient.Headers.Add(HttpRequestHeader.Accept, "application/json");
            webClient.Headers.Add(HttpRequestHeader.ContentType, "application/json");
            string requestJson = JsonConvert.SerializeObject(sentimentRequest);
            byte[] requestBytes = Encoding.UTF8.GetBytes(requestJson);
            byte[] response = webClient.UploadData("https://centralus.api.cognitive.microsoft.com/text/analytics/v2.0/sentiment", requestBytes);
